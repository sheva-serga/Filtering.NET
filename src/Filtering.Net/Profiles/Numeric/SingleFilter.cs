...
public static class SingleFilter
{
    ...
    /// <param name="value">The extracted float, or <c>0</c> on failure.</param>
    ...
    /// <summary>Extracts a <see cref="float"/>[] from a JSON Array; each element parsed via <see cref="TryGetValue"/>.</summary>
    /// <param name="element">The JSON array to read.</param>
    /// <param name="values">The extracted floats, or an empty array on failure.</param>
    /// <param name="error">A human-readable explanation of the failure.</param>
