    ...
    partial class UserFilter : global::Filtering.Net.FilterDefinition<global::Sample.User>
    {
        ...
        internal static global::Filtering.Net.FilterSchema<global::Sample.User> CreateSchema(global::System.Text.Json.JsonSerializerOptions? serializerOptions, global::Filtering.Net.FilterNestingContext nestingContext) =>
            new global::Filtering.Net.FilterSchemaBuilder<global::Sample.User>(
                    ...
                    serializerOptions)
                .Add(global::Filtering.Net.FilterProperty.Map("Department.Name", (global::Sample.User entity) => entity.Department.Name, global::Filtering.Net.StringFilter.Profile)
                    .Alias("dept")
                    .Build())
                .Build();
    }
